...
const allCommentPost = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const postId = req.params.id; // validated by `validateParams`
...
const editComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const commentId = req.params.id; // validated by `validateParams`
        const text = req.body.comment; // validated by `validateBody`
