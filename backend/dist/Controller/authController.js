...
const userProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        const targetIdRaw = (_a = req.params) === null || _a === void 0 ? void 0 : _a.id;
        const targetId = targetIdRaw ? Number(targetIdRaw) : (_b = req.user) === null || _b === void 0 ? void 0 : _b.id;
        if (!targetId || Number.isNaN(targetId)) {
            return res.status(400).json({ message: "Invalid user id" });
        }
        const user = yield authService_1.default.getFullUserProfile(targetId);
...
const editUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const user = yield authService_1.default.editedUser(userId, req.body);
        return res.json({ user });
    }
    catch (error) {
...
const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
        const user = yield authService_1.default.deleteUserWithRelation(userId);
        return res.json({ user });
    }
    catch (error) {
